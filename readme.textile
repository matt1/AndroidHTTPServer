...
Android 2.2.1 it can serve a small test page at approximately 450 requests/s when debugging and approximately 1800 
requests/s when not debugging (based on 10 simultaneous JMeter threads - please check Test Plan.jmx for exact settings).  
